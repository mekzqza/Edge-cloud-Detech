...
const nav = [
  ...
  { href: "/records", label: "บันทึกการเข้า", d: ["M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4", "m10 17 5-5-5-5", "M15 12H3"] },
  { href: "/exits", label: "บันทึกการออก", d: ["M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4", "m16 17 5-5-5-5", "M21 12H9"] },
